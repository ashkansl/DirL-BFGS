        ...
        while n_iter < max_iter:
            ...
            if state['n_iter'] == 1:
                ...
                if fast_version:
                    ...
                    tempH_G11 = torch.sum((gbetas_tensor[0:gemx]*(gv_tensor[0:gemx] @ flat_grad.reshape(-1, 1)))*gu_tensor[0:gemx], 0)
                    tempH_G22 = torch.sum((betas_tensor[0:emx]*(v_tensor[0:emx] @ flat_grad.reshape(-1, 1)))*u_tensor[0:emx], 0)
            ...
            if  state['n_iter'] >= history_size-1  and restart==True:
            ...
            if tolerance_change_gtd:
                if gtd > -tolerance_change: # TIME CONSUMING !!! TODO
                    break
